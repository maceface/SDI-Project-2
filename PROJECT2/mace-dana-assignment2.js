...
//Yay!!!!!!  I got it... now there's a problem with the Array... of course.
...
var getMoreFuel = function (creditCard, toppedOffPlane) {
    ...
    console.log('He said, "We take credit."  I said, "In that case, I\'ll be paying with the plastic."');
    return true;
        } else {
